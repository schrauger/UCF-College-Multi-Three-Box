...
git remote add dev        ssh://git@vps1.med.ucf.edu:32/var/www/repositories/dev/UCF-College-Multi-Three-Box.git
...
#fi
#git remote add staging    ssh://git@vps1.med.ucf.edu:32/var/www/repositories/staging/UCF-College-Multi-Three-Box.git
...
git remote add production ssh://git@vps1.med.ucf.edu:32/var/www/repositories/production/UCF-College-Multi-Three-Box.git
